...
#define CS_LOCATION 29 // map location
...
#define EF_STATIC		0x00160000		// for missiles
#define EF_SHRAPNEL             0x00320000              // for shrapnel movement
...
#define MASK_MOOR				(CONTENTS_MOOR)
