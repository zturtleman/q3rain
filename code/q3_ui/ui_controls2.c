...
static bind_t g_bindings[] = {
    ...
    {"weapon 1", "Hands", ID_WEAPON1, ANIM_WEAPON1, '1', -1, -1, -1},
    {"weapon 2", "Knife", ID_WEAPON2, ANIM_WEAPON2, '2', -1, -1, -1},
    {"weapon 3", "HE Grenade", ID_WEAPON3, ANIM_WEAPON3, '3', -1, -1, -1},
    {"weapon 4", "Barrett M82A1", ID_WEAPON4, ANIM_WEAPON4, '4', -1, -1, -1},
    {"weapon 5", "Intervention M200", ID_WEAPON5, ANIM_WEAPON5, '5', -1, -1, -1},
    {"weapon 6", "Crossbow", ID_WEAPON6, ANIM_WEAPON6, '6', -1, -1, -1},
...
static void Controls_UpdateModel(int anim) {
    ...
    switch (anim) {
        ...
        case ANIM_WEAPON1:
            s_controls.playerWeapon = WP_HANDS;
            break;
        ...
        case ANIM_WEAPON3:
            s_controls.playerWeapon = WP_HE;
            break;

        case ANIM_WEAPON4:
            s_controls.playerWeapon = WP_BARRETT;
            break;

        case ANIM_WEAPON5:
            s_controls.playerWeapon = WP_INTERVENTION;
            break;

        case ANIM_WEAPON6:
            s_controls.playerWeapon = WP_CROSSBOW;
            break;

        case ANIM_WEAPON7:
            s_controls.playerWeapon = WP_WALTHER;
            break;

        case ANIM_WEAPON8:
            s_controls.playerWeapon = WP_ACR;
            break;

        case ANIM_WEAPON9:
            s_controls.playerWeapon = WP_BOMB;
            break;

        case ANIM_WEAPON10:
            s_controls.playerWeapon = WP_INJECTOR;
            break;
