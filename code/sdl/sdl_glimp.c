...
static void GLimp_InitExtensions(void) {
    ...
    if (GLimp_HaveExtension("GL_EXT_framebuffer_object")) {
        if (r_ext_framebuffer_object->integer) {
            ...
            qglIsRenderbufferEXT = (GLboolean(APIENTRYP) (GLuint)) SDL_GL_GetProcAddress("glIsRenderbufferEXT");
            qglBindRenderbufferEXT = (GLvoid(APIENTRYP) (GLenum, GLuint)) SDL_GL_GetProcAddress("glBindRenderbufferEXT");
            qglDeleteRenderbuffersEXT = (GLvoid(APIENTRYP) (GLsizei, const GLuint *)) SDL_GL_GetProcAddress("glDeleteRenderbuffersEXT");
            qglGenRenderbuffersEXT = (GLvoid(APIENTRYP) (GLsizei, GLuint *)) SDL_GL_GetProcAddress("glGenRenderbuffersEXT");
            qglRenderbufferStorageEXT = (GLvoid(APIENTRYP) (GLenum, GLenum, GLsizei, GLsizei)) SDL_GL_GetProcAddress("glRenderbufferStorageEXT");
            qglGetRenderbufferParameterivEXT = (GLvoid(APIENTRYP) (GLenum, GLenum, GLint *)) SDL_GL_GetProcAddress("glGetRenderbufferParameterivEXT");
            qglIsFramebufferEXT = (GLboolean(APIENTRYP) (GLuint)) SDL_GL_GetProcAddress("glIsFramebufferEXT");
            qglBindFramebufferEXT = (GLvoid(APIENTRYP) (GLenum, GLuint)) SDL_GL_GetProcAddress("glBindFramebufferEXT");
            qglDeleteFramebuffersEXT = (GLvoid(APIENTRYP) (GLsizei, const GLuint *)) SDL_GL_GetProcAddress("glDeleteFramebuffersEXT");
            qglGenFramebuffersEXT = (GLvoid(APIENTRYP) (GLsizei, GLuint *)) SDL_GL_GetProcAddress("glGenFramebuffersEXT");
            qglCheckFramebufferStatusEXT = (GLenum(APIENTRYP) (GLenum)) SDL_GL_GetProcAddress("glCheckFramebufferStatusEXT");
            qglFramebufferTexture1DEXT = (GLvoid(APIENTRYP) (GLenum, GLenum, GLenum, GLuint, GLint)) SDL_GL_GetProcAddress("glFramebufferTexture1DEXT");
            qglFramebufferTexture2DEXT = (GLvoid(APIENTRYP) (GLenum, GLenum, GLenum, GLuint, GLint)) SDL_GL_GetProcAddress("glFramebufferTexture2DEXT");
            qglFramebufferTexture3DEXT = (GLvoid(APIENTRYP) (GLenum, GLenum, GLenum, GLuint, GLint, GLint)) SDL_GL_GetProcAddress("glFramebufferTexture3DEXT");
            qglFramebufferRenderbufferEXT = (GLvoid(APIENTRYP) (GLenum, GLenum, GLenum, GLuint)) SDL_GL_GetProcAddress("glFramebufferRenderbufferEXT");
            qglGetFramebufferAttachmentParameterivEXT = (GLvoid(APIENTRYP) (GLenum, GLenum, GLenum, GLint *)) SDL_GL_GetProcAddress("glGetFramebufferAttachmentParameterivEXT");
            qglGenerateMipmapEXT = (GLvoid(APIENTRYP) (GLenum)) SDL_GL_GetProcAddress("glGenerateMipmapEXT");
        } else {
...
void GLimp_EndFrame(void) {
    ...
    if (s) {
        ...
        if (r_minimize->integer) {
            // Toggle to windowed mode after turning into an icon
            if (fullscreen) {
            ...
            // If we managed to minimize
            if (SDL_WM_IconifyWindow()) {
                SDL_WM_GrabInput(SDL_GRAB_OFF);
                SDL_ShowCursor(1);
            }

            // We are no longer minimizing (we have minimized)
